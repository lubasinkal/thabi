...
def main():
    ...
    if use_climate:
        ...
        q_mean = scenarios_df[scenarios_df['Scenario'] == 'Average Climate']['q_estimate'].values[0]
        q_adverse = scenarios_df[scenarios_df['Scenario'] == '95th Percentile (Adverse)']['q_estimate'].values[0]
        q_extreme = scenarios_df[scenarios_df['Scenario'] == '99th Percentile (Extreme)']['q_estimate'].values[0]
    ...
    if use_climate:
        baseline_tvar = pricing_df[pricing_df['Scenario'] == 'Baseline']['TVaR_99'].values[0]
        adverse_tvar = pricing_df[pricing_df['Scenario'] == 'Adverse Climate']['TVaR_99'].values[0]
